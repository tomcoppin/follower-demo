...
enum PATH_STATE1{
	UP,	// go along circle trajectory
	DOWN,
	STOP1	// move to the new circle (when radius or center change)
};
...
enum PATH_STATE2{
	LEFT,	// go along circle trajectory
	RIGHT,
	STOP2	// move to the new circle (when radius or center change)
};
...
class Raven_PathPlanner
{
	...
	public:
		...
		void show_Center();
		void show_delPos();
		PATH_STATE1 PathState1;
		PATH_STATE2 PathState2;
...
*/
		...
		tf::Transform ComputeFollowTrajectory();
};
#endif
